...
void AccelStepper::moveToNoSpeedReCalc(long absolute)
{
    if (_targetPos != absolute)
    {
	_targetPos = absolute;
...
float AccelStepper::getAcceleration()
{
...
AccelStepper::AccelStepper(uint8_t interface, uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4, bool enable)
{
    ...
    //Newer, added by Thorstein R Rykkkje
    _constForsetC0 = 0.676*0.676*1000000.0*1000000.0*2;
...
AccelStepper::AccelStepper(void (*forward)(), void (*backward)())
{
    ...
    //Newer, added by Thorstein R Rykkje
    _constForsetC0 = 0.676*0.676*1000000.0*1000000.0*2;
...
//This is new-----------------------------------------------------------------------
void AccelStepper::setC0(float c0)
{
    if(c0<0){
        _c0 = -c0;
    }  
    ...
    float acceleration = _constForsetC0/(c0*c0);
