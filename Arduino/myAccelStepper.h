...
public:
    ...
    void moveToNoSpeedReCalc(long absolute);
    ...
    /// NEW FUNCTION ADDED 06.4.2022 by Thorstein R Rykkje
    /// Set c0 directly, enabling acceleration calculation on an external devise.
    void    setC0(float c0);
...
private:
    ...
    /// Constant used in setC0
    float _constForsetC0;
