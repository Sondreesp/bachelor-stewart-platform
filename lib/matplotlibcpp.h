...
void myRealtimePloter(std::vector<float> x, std::vector<float> y, const char* Legend, const char* Title){


		clf();
		named_plot(Legend, x, y);
		xlim(x.front(),x.back());
		title(Title);
		legend();
		pause(0.1);
...
void myRealtimePloter(std::vector<float> x, std::vector<float> y1, std::vector<float> y2, const char* Legend1, const char* Legend2, const char* Title){


		clf();
        named_plot(Legend1, x,y1);
		named_plot(Legend2, x, y2);
		xlim(x.front(),x.back());
		title(Title);
		legend();
		pause(0.1);
