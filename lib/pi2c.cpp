...
////////////////////////////////////////////////////////////////////////////////
// pi2c.cpp:Original found at github.com/JohnnySheppard/Pi2c
// Edited by Thorstein R Rykkje to enable several arduino on the bus.
//////////////////////////////////////////////////////////////////////////////// 
#include "pi2c.h"
...
int Pi2c::i2cChangeSlave(int address){

// Using ioctl to set the slave being talked to
	if(ioctl(i2cHandle_, I2C_SLAVE, address) <0){
		std::cout << "Can't set the I2C address for slave device" << std::endl;
		return -1;
	}
